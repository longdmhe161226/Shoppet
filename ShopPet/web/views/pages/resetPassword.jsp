...
<html>
    ...
    <body>
        <div class="row">
            ...
            <h3>${email}</h3>
            <form action="${path}/account/reset-password" method="POST">
                <div class="form-group">
                    
                    <input type="password" name="newpassword" id="user_email">
                    <input type="hidden" name="email" value="${email}">
                    <p><label for="username">Password</label></p>

                </div>
                <div class="form-group">
                    <input type="password" name="cfpassword" id="user_email">
                    <p><label for="username">Confirm Password</label></p>
                    <h3 style="color: red">${msp}</h3>
