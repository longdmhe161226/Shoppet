...
public class ShowProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listAllProduct = a.getPagingAllInfor(6,page * numberpage);
        List<Product> listAllProductByCategory = a.getSearchAllProductbyCategoryID(6, page * numberpage, cid, check);
