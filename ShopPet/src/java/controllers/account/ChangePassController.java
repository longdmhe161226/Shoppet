...
public class ChangePassController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
//        response.getWriter().print("davao");
        ...
        if (!oldpassword.equals(acc.getPassword())) {
            String msop = "Incorrect";
            request.setAttribute("msop", msop);
            i++;
        }
        ...
        try {
            ...
            if (i == 0) {
                ...
                as.update(acc);
                session.setAttribute(loginSession, acc);
                request.setAttribute("sucs", "Success");
            }
            ...
            //request.getRequestDispatcher("/changepass-fail.jsp").forward(request, response);
