...
public class HomeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       ProductService a = new ProductService();
        ...
        boolean check= d.getPetIdFromCategoryId(id);
         List<Product> listAllProductByCategory = a.getSearchAllProductbyCategoryID(10,0,id,check);
        List<Category> listCategory = c.getAllCategory();
        request.setAttribute("listCategory", listCategory);
        request.setAttribute("cid", id);
        request.setAttribute("listRandom", listAllProductByCategory);
